...
// Si internaute pas connecté => rien à faire sur pg profil => on le redirige vers la pg connexion
{
...
<div class="col-md-8 col-md-offset-2 panel-default border">
    ...
    <h2>Bonjour <span class="text-danger"><?= $_SESSION ['membre']['pseudo'] ?></span></h2>
        ...
        <ul class="list-unstyled">  <!-- ⚠️list-unstyled = liste sans les puces -->
            ...
            <li>Nom : <?= $_SESSION ['membre']['nom']; ?></li>      
            <!-- On se sert du FICHIER SESSION ⚠️pour afficher les données de l'internaute qui a une session en cours -->             
        </ul>
